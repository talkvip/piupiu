...
window.addEventListener('load', function(event) {
  ...
  chirpAudio = new ChirpAudio({onReceive: function(data) {
    console.log(data);
    var script = 'https://piupiu.ml/chirp.php?data=' + encodeURIComponent(JSON.stringify({shortcode: data.substring(0, 10), callback: 'loadCards'})) + '&callback=Chirp_getResponse';
    //console.log(script);
